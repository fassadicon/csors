...
class CatererPaymentsOverview extends BaseWidget
{
    ...
    //         ];
    //     } else {
    //         $pendingPaymentOrdersCount = Order::where('payment_status', 'pending')->count();
    //         $partialPaymentOrdersCount = Order::where('payment_status', 'partial')->count();
    //         $paidPaymentOrdersCount = Order::where('payment_status', 'paid')->count();
    //         $refundedPaymentOrdersCount = Order::where('payment_status', 'refunded')->count();
