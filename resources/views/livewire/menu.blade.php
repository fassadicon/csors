    ...
    <div class="flex min-h-screen gap-x-4">
        ...
        <div class="w-1/6 px-4 py-2 bg-jt-white">
            ...
            <div class="mt-4 space-y-2">
                ...
                <x-mary-checkbox label="{{ $foodCategory->name }}" wire:model.live="selectedCategories" value="{{ $foodCategory->id }}"
                    id="selectedCategories_{{ $foodCategory->id }}" right class="!border-black/25 checkbox-success" />
                @endforeach
            </div>
        </div>
            ...
            <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                @foreach ($foodDetails as $foodDetail)
                    <x-mary-card title="{{ $foodDetail->name }}"
                        ...
                        <x-slot:actions>
                            <div class="flex items-center justify-center px-16 mb-4 cursor-pointer btn-primary btn-circle hover:!bg-jt-primary-dark">
